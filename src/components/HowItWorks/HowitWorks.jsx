        ...
        <div className="md:w-11/12 md:mx-auto mt-20 mb-10">
            <div className="flex flex-col gap-2 items-center">
                ...
                <div className="flex gap-4 w-full mt-10 justify-center">
                    ...
                    <div className="w-1/4 p-5  flex flex-col gap-3  items-center justify-center border-2 bg-gray-50 rounded-lg relative overflow-hidden">
                    ...
                    <div className="w-1/4 p-5 flex flex-col gap-3 items-center text-center justify-center border-2 bg-gray-50 rounded-lg relative overflow-hidden">
                        <div className="absolute inset-0  mix-blend-multiply"></div>
