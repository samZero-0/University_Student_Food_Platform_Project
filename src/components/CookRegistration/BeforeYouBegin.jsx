    ...
    return (
        <div className="md:w-11/12 md:mx-auto  mt-28 mb-5">
            ...
            <div className="flex flex-col gap-3 items-center  ">
                ...
                <span  className="text-2xl font-bold md:text-4xl">Requirements for Becoming a Seller</span></div>

                <div className="md:flex md:flex-row flex flex-col items-center gap-2 mt-16 border border-gray-300 rounded-xl p-4 w-11/12 md:w-1/2 shadow-lg">
                <PiNumberSquareOneBold  className="text-3xl font-bold text-accent"/>
                <img src="/student.webp" alt="" className="h-[100px] w-1/8"/>
            ...
            <div className="md:flex md:flex-row flex flex-col items-center gap-7 mt-10 border border-gray-300 rounded-xl p-4 w-11/12 md:w-1/2 shadow-lg" >
                <PiNumberSquareTwoBold  className="text-3xl font-bold text-accent"/>
                <img src="/food-safety.webp" alt="" className="h-[100px] w-1/8"/>
                <div className="flex flex-col gap-2">
            ...
            <div className="md:flex md:flex-row flex flex-col items-center gap-7 mt-10 border border-gray-300 rounded-xl p-4 w-11/12 md:w-1/2 shadow-lg">
                ...
                <img src="/price.png" alt="" className="h-[100px] w-1/8"/>
                <div className="flex flex-col gap-2">
            ...
            <div className="md:flex md:flex-row flex flex-col items-center gap-7 mt-10 border border-gray-300 rounded-xl p-4 w-11/12 md:w-1/2 shadow-lg">
                ...
                <img src="/delivery.jpg" alt="" className="h-[100px] w-1/8"/>
                <div className="flex flex-col gap-2">
          ...
          <Link to='/cookReg' className="w-full flex justify-center"><button className="p-3 bg-primary rounded-xl md:w-1/3 text-center text-black font-bold text-xl">I agree and want to continue</button></Link>
