  ...
  return (
    <div className="md:w-11/12 md:mx-auto mt-28 mb-5">
      <div className="flex flex-col gap-2 items-center">
        ...
        <div className="md:diff aspect-[16/9] mt-10 hidden">
          ...
          >
            <div className="bg-base-200 bg-opacity-10 grid place-content-center text-9xl font-black">
              Menu <div className="flex flex-col gap-4">
                <span className="text-7xl text-white">Compliance</span>
        ...
        <div className="md:flex md:flex-row flex flex-col w-full gap-11 md:mt-5">
          <div className="md:w-1/2">
            <div className="md:flex md:flex-row flex flex-col items-center gap-2 mt-16 border border-gray-300 rounded-xl p-4 md:w-full shadow-lg">
              ...
              />
              <div className="flex flex-col gap-2 items-center">
                <span className="text-xl md:text-2xl font-semibold">University Enrollment</span>
            ...
            <div className="md:flex md:flex-row flex flex-col items-center gap-7 mt-10 border border-gray-300 rounded-xl p-4 md:w-full shadow-lg">
              ...
              />
              <div className="flex flex-col gap-2 items-center">
                <span className="text-xl md:text-2xl font-semibold">Food Quality and Safety</span>
                <span className="text-center">
            ...
            <div className="md:flex md:flex-row flex flex-col items-center gap-7 mt-10 border border-gray-300 rounded-xl p-4 md:w-full shadow-lg">
              ...
              />
              <div className="flex flex-col gap-2 items-center">
                <span className="text-xl md:text-2xl font-semibold">Pricing Guidelines</span>
                <span className="text-center">
          ...
          <div className="flex flex-col md:w-1/2 mt-5 p-3 md:p-0">
